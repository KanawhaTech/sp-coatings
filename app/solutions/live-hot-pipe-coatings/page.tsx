...
export const metadata: Metadata = {
  title: "Live Hot Pipe Coatings - SP Coatings",
...
export default function LiveHotPipeCoatingsPage() {
  return (
    <SolutionPage
      ...
      description="Traditional pipe insulation requires a complete plant shutdown, cool-down, installation of insulation materials, and restart — a process that can take days or weeks and cost millions in lost production. SP Coatings' revolutionary HPC® system is applied like paint while the pipe is hot and in service. There is no shutdown, no lost production and no scaffolding-intensive installation. The coating cures in place to form a thick, durable thermal insulation system that dramatically reduces heat loss, surface temperatures and energy consumption. Recognised by the US EPA ENERGY STAR programme."
      benefits={[

...
export const metadata: Metadata = {
  title: "Water Resistance Coatings - SP Coatings",
...
export default function WaterResistancePage() {
  return (
    <SolutionPage
      ...
      description="Water is one of the most destructive forces acting on buildings and infrastructure. Water ingress causes structural damage, mould growth, corrosion of steel reinforcement and deterioration of finishes. SP Coatings' SP Liquid Membrane® provides a seamless, flexible waterproof barrier that eliminates joints and laps — the most common failure points in conventional waterproofing systems. It bridges cracks, remains flexible through temperature cycling and provides long-term waterproofing protection."
      benefits={[

...
export const metadata: Metadata = {
  title: "Fire Resistance Coatings - SP Coatings",
...
export default function FireResistancePage() {
  return (
    <SolutionPage
      ...
      description="Structural steel loses strength rapidly when exposed to fire — at around 550°C, structural steel begins to fail, potentially causing catastrophic building collapse. Passive fire protection coatings prevent steel from reaching these critical temperatures by forming an insulating char layer when exposed to fire. Omega Fire from SP Coatings is an intumescent coating that expands dramatically when exposed to heat, creating a thick, insulating char that can provide up to 4 hours of rated fire resistance, giving occupants time to evacuate and fire services time to respond."
      benefits={[
